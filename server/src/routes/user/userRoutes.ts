...
router.post("/reset-password", userController.resendOtp); //since the logic is same for getting otp for resetting password and resending otp we can use the same controller for both
